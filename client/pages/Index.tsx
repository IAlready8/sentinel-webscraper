        ...
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="text-foreground/70 text-lg">
              Advanced browser automation with stealth capabilities, intelligent
              proxy rotation, dynamic rate limiting, and a real-time analytics
              dashboard. Production-ready from day one.
            </p>
            ...
            <Card className="relative">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-base font-semibold">
                  <BarChart3 className="h-5 w-5 text-primary" /> Realtime
                  Metrics Preview
                </CardTitle>
              </CardHeader>
              <CardContent>
    ...
    <section id="features" className="container py-16 md:py-20">
      <div className="grid gap-6 md:grid-cols-3">
        <Feature
          ...
          desc="Anti-detection mechanisms with user-agent and fingerprint rotation, headless hardening, and automation signal suppression."
        />
        <Feature
          icon={<Server className="h-5 w-5" />}
          title="Proxy Intelligence"
          desc="Sophisticated proxy pool with validation, adaptive rotation, and health scoring for true resilience."
        />
        <Feature
          icon={<Gauge className="h-5 w-5" />}
          title="Dynamic Rate Limits"
          desc="Global and per-domain throttling with burst control to respect targets and avoid bans."
        />
      </div>
    </section>
  );
      ...
      <div className="container py-16 md:py-20 grid gap-6 md:grid-cols-3">
        ...
        <InfoCard
          ...
          points={[
            ...
            "Form, table, image insights",
          ]}
        />
        <InfoCard
          icon={<PlugZap className="h-5 w-5 text-primary" />}
          title="Extensible Addons"
          points={[
            "Plugin architecture",
            "Config hot-reload",
            "Typed API & storage",
    ...
    <section className="container py-16 md:py-24">
      <div className="rounded-2xl border bg-gradient-to-br from-primary/10 to-accent/10 p-8 md:p-12 text-center">
        ...
        <p className="mt-3 text-foreground/70 max-w-2xl mx-auto">
          Configure once and run. Advanced monitoring, error recovery, and data
          validation ensure enterprise-grade reliability.
        </p>
